...
from applications.autotest.services.autotest_runtime.builtin_variables import (
...
from core.exceptions import NotFoundException, ParameterException, ReqInvalidException
from enums import AutoTestConfigNodeType, AutoTestReqArgsType, AutoTestStepType
...
class StepDebugService:
    ...
    async def debug_tcp(
        ...
        :return: 调试结果字典
        """
        from common import AsyncTcpUtils
    ...
    async def debug_python(cls, debug_in: AutoTestPythonCodeDebugRequest) -> Dict[str, Any]:
        ...
        """
        from applications.autotest.services.autotest_step_engine import (
    ...
    async def debug_redis(
        ...
        :return: 调试结果字典
        """
        from applications.autotest.services.autotest_step_engine import RedisStepExecutor
