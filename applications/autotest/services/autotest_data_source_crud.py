...
from applications.autotest.schemas.autotest_data_source_schema import AutoTestDataSourceCreate, AutoTestDataSourceUpdate
...
class AutoTestDataSourceCrud(ScaffoldCrud[AutoTestDataSourceModel, AutoTestDataSourceCreate, AutoTestDataSourceUpdate]):
    ...
    async def create_data_sources_from_parsed(
        ...
        from applications.autotest.services.autotest_data_source_parser import normalize_dataset_record
