...
from applications.autotest.models.autotest_detail_model import AutoTestDetailModel
from applications.autotest.schemas.autotest_detail_schema import (
...
class AutoTestDetailCrud(ScaffoldCrud[AutoTestDetailModel, AutoTestApiDetailCreate, AutoTestApiDetailUpdate]):
    ...
    async def select_details_copy(self, search: Q, page: int, page_size: int, order: List[str]) -> Tuple[int, List[AutoTestDetailModel]]:
        """
        根据条件分页查询明细列表。
