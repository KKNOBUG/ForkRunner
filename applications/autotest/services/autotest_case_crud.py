...
from applications.autotest.schemas.autotest_case_schema import AutoTestApiCaseCreate, AutoTestApiCaseUpdate
...
from enums import AutoTestCaseType, AutoTestStepType, PUBLIC_CASE_TYPES, NO_TAG_CASE_TYPES, AutoTestReqArgsType
        ...
        for cid, case_data in enumerate(cases_data, start=1):
            ...
            if not case_instance:
                ...
                if "case_name" in update_case_dict or "case_project" in update_case_dict or "case_type" in update_case_dict:
                    ...
                    unique_case_type = update_case_dict.get("case_type", case_instance.case_type)
