...
from applications.autotest.schemas.autotest_data_source_schema import (
...
async def download_import_template():
    ...
    :return: 文件流响应
    """
    filepath = os.path.normpath(os.path.join(PROJECT_CONFIG.OUTPUT_DIR, "template", "数据驱动模板.xlsx"))
