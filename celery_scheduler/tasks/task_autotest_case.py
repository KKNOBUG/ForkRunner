...
def _should_close_schedule(task: Any) -> bool:
    ...
    :return: 应关闭为True
    """
    from applications.autotest.services.autotest_task_schedule import TaskSchedule
...
async def _run_autotest_task_impl(task_id: int, report_type: Optional[AutoTestReportType] = None, execute_user: Optional[str] = None) -> Dict[
    str, Any]:
    """
